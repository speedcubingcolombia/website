 ...
 */
export const SLUG_TRANSLATIONS: Record<string, Record<SupportedLanguage, string>> = {
  ...
  'sac-2026/pagos': { es: 'sac-2026/pagos', en: 'sac-2026/payments', pt: 'sac-2026/pagamentos' },
  'sac-2026/cronograma': { es: 'sac-2026/cronograma', en: 'sac-2026/schedule', pt: 'sac-2026/cronograma' },
  'sac-2026/sede-transporte': { es: 'sac-2026/sede-transporte', en: 'sac-2026/venue', pt: 'sac-2026/local' },
  'sac-2026/alojamiento-alimentacion': { es: 'sac-2026/alojamiento-alimentacion', en: 'sac-2026/accommodation', pt: 'sac-2026/hospedagem' },
  'sac-2026/turismo': { es: 'sac-2026/turismo', en: 'sac-2026/tourism', pt: 'sac-2026/turismo' },
  'sac-2026/patrocinadores': { es: 'sac-2026/patrocinadores', en: 'sac-2026/sponsors', pt: 'sac-2026/patrocinadores' },
  'sac-2026/staff': { es: 'sac-2026/staff', en: 'sac-2026/staff', pt: 'sac-2026/equipe' },
};

/**
 * Get the canonical (Spanish) slug from any translated slug
 */
export function getCanonicalSlug(slug: string, fromLang: SupportedLanguage): string {
  if (fromLang === 'es') return slug;
  
  for (const [canonicalSlug, translations] of Object.entries(SLUG_TRANSLATIONS)) {
 ...
 */
export async function getAvailableLanguages(canonicalSlug: string): Promise<SupportedLanguage[]> {
  ...
  const esExists = allPosts.some(post => {
    ...
    return normalizedSlug === canonicalSlug && 
