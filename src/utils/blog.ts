 ...
 */
export const SLUG_TRANSLATIONS: Record<string, Partial<Record<SupportedLanguage, string>>> = {
  // SAC 2026 sections with translated URLs
  "sac-2026/registro": { en: "sac-2026/registration", pt: "sac-2026/inscricao" },
  ...
  "sac-2026/alojamiento-alimentacion": { en: "sac-2026/accommodation", pt: "sac-2026/hospedagem" },
 ...
 */
export function getTranslatedSlug(canonicalSlug: string, targetLang: SupportedLanguage): string {
 ...
 */
export function getLocalizedBlogUrl(canonicalSlug: string, lang: SupportedLanguage): string {
